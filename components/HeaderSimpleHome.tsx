              ...
              <Group gap={5} justify="space-around">
                <Group gap={5} visibleFrom="xs" justify="flex-start">
                  <MantineProvider theme={theme}>
                    <Button variant="transparent" size="lg" color='black' component="a" href="#home-section"><Title>Nyseer<span style={{ color: 'blue' }}>.</span></Title></Button>
                  </MantineProvider>
                </Group>
